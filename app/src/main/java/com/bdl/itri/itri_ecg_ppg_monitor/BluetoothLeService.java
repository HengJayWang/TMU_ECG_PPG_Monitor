...
public class BluetoothLeService extends Service {
    ...
    public final static String ECG_DATA =
            "ITRI_HengJay.ECG_DATA";
    public final static String PPG_DATA =
            "ITRI_HengJay.PPG_DATA";

    public static String String_ITRI_ECG_PPG_Monitor_Service =
            "0000FFE0-0000-1000-8000-00805F9B34FB";
    public static String String_ITRI_ECG_PPG_Monitor_Data =
    ...
    private void broadcastUpdate(final String action,
        ...
        */
        ...
        Log.d("myTAG", "BluetoothLeService.broadcastUpdate()");
        ...
        if (data != null && data.length > 0) {
            ...
            if ( stringBuilder.toString().substring(51, 53).equals("00")  ){
                intent.putExtra(ECG_DATA, stringBuilder.toString().substring(54, 56) );
                intent.putExtra(PPG_DATA, stringBuilder.toString().substring(57, 59) );
            }else if ( stringBuilder.toString().substring(54, 56).equals("00") ){
                intent.putExtra(ECG_DATA, stringBuilder.toString().substring(57, 59) );
                intent.putExtra(PPG_DATA, stringBuilder.toString().substring(51, 53) );
            }else{
                intent.putExtra(ECG_DATA, stringBuilder.toString().substring(51, 53) );
                intent.putExtra(PPG_DATA, stringBuilder.toString().substring(54, 56) );
            }
